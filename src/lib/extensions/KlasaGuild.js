...
module.exports = Structures.extend('Guild', Guild => {
	...
	class KlasaGuild extends Guild {
		...
		constructor(...args) {
			 ...
			 * @type {Settings}
			 */
			this.settings = this.client.gateways.get('guilds').acquire(this, this.id);
		}
		 ...
		 */
		get language() {
			return this.client.languages.get(this.settings.get('language')) || this.client.languages.get('en-US') || null;
		}
